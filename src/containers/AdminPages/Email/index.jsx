...
import { Mail, Star, Send, File, Trash2, Tag, Users, Menu, Plus, MoreHorizontal} from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-100">
        <div className="w-64 bg-white h-screen p-4 flex flex-col fixed left-0 top-0" style={{ marginLeft: "243px", paddingTop: "65px" }}>
            ...
            <div className="mt-6 space-y-1 flex-grow">
                <SidebarItem icon={Mail} text="Inbox" count={14} active />
                <SidebarItem icon={Star} text="Starred" />
                <SidebarItem icon={Send} text="Sent" />
                <SidebarItem icon={File} text="Drafts" />
                <SidebarItem icon={Trash2} text="Deleted" />
            </div>
